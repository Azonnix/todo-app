...
import (
	...
	todo "github.com/azonnix/todo-app"
...
// GenerateTocken mocks base method.
func (m *MockAuthorization) GenerateTocken(username, password string) (string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GenerateTocken", username, password)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GenerateTocken indicates an expected call of GenerateTocken.
func (mr *MockAuthorizationMockRecorder) GenerateTocken(username, password interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GenerateTocken", reflect.TypeOf((*MockAuthorization)(nil).GenerateTocken), username, password)
}
...
// Create mocks base method.
func (m *MockTodoItem) Create(userId, listId int, input todo.TodoItem) (int, error) {
	m.ctrl.T.Helper()
